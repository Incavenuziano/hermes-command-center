    ...
    <div className="hc-flex-col" style={{ gap: 16 }}>
      ...
      <div className="hc-grid hc-grid-2-1">
        ...
        <Panel title="Circuit breaker" icon="shield" sub={u.breaker.tripped ? 'tripped' : 'healthy'}>
          ...
          <button className="hc-btn primary" style={{ width: '100%', marginTop: 8, justifyContent: 'center' }} onClick={() => {
            ...
            if (!Number.isNaN(cost) && !Number.isNaN(tokens)) {
              postJsonB('/ops/costs/circuit-breaker', { max_actual_cost_usd: cost, max_total_tokens: tokens }).then((r) => { if (r) window.location.reload(); });
            }
